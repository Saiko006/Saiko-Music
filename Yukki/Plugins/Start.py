...
from Yukki import ASSIDS,BOT_USERNAME, BOT_ID, MUSIC_BOT_NAME, OWNER_ID, SUDOERS, app
...
@app.on_message(filters.command(["setting", f"settings@{BOT_USERNAME}"]) & filters.group)
