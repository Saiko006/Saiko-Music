...
def search_markup(
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="1️⃣", callback_data=f"VideoStream {ID1}|{duration1}|{user_id}"
            ),
            InlineKeyboardButton(
                text="2️⃣", callback_data=f"VideoStream {ID2}|{duration2}|{user_id}"
            ),
            InlineKeyboardButton(
                text="3️⃣", callback_data=f"VideoStream {ID3}|{duration3}|{user_id}"
            ),
        ],
        [
            InlineKeyboardButton(
                text="4️⃣", callback_data=f"VideoStream {ID4}|{duration4}|{user_id}"
            ),
            InlineKeyboardButton(
                text="5️⃣", callback_data=f"VideoStream {ID5}|{duration5}|{user_id}"
            ),
        ],
        [
            InlineKeyboardButton(
...
def search_markup2(
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="6️⃣",
                callback_data=f"VideoStream {ID6}|{duration6}|{user_id}",
            ),
            InlineKeyboardButton(
                text="7️⃣",
                callback_data=f"VideoStream {ID7}|{duration7}|{user_id}",
            ),
            InlineKeyboardButton(
                text="8️⃣",
                callback_data=f"VideoStream {ID8}|{duration8}|{user_id}",
            ),
        ],
        [
            InlineKeyboardButton(
                text="9️⃣",
                callback_data=f"VideoStream {ID9}|{duration9}|{user_id}",
            ),
            InlineKeyboardButton(
                text="🔟",
                callback_data=f"VideoStream {ID10}|{duration10}|{user_id}",
            ),
        ],
        [
            InlineKeyboardButton(
